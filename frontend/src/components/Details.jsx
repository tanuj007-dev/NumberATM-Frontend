...
// export default Details;
 import React, { useState, useEffect, useRef } from "react";
  ...
  import { FiChevronDown, FiChevronUp } from "react-icons/fi";
  import vid from "../components/assets/vid.jpg";
            ...
            <div className="rounded-2xl flex flex-col items-center border-2 border-[rgb(255,207,81)] py-2">
              ...
              <div className="relative flex justify-between items-center gap-2 w-full text-xs sm:text-sm p-2">
                ...
                <button
                  ...
                  className="font-semibold px-4 py-1 w-1/2 rounded-full border-2 border-[#F5C037] text-[#17535D] hover:bg-white hover:border-[#17535D] hover:text-[#17535D] transition-all duration-300 flex items-center justify-center gap-2 shadow-md"
                  style={{
    ...
    <p className="tracking-[-0.05em] leading-tight">
      <strong>Instant Activation:</strong> Get your VIP number quickly & easily.
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg shadow-md">
              ...
              <p className=" md:text-lg text-md m-2 md:m-2 text-gray-700">
